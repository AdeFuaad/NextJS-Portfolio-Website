...
import image3 from '@/images/photos/mety.jpg'
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://harlequin-ceciley-77.tiiny.site" target="_blank" rel="noopener noreferrer" variant="secondary" className="group mt-6 w-full">
        Download CV
